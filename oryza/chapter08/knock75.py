...
if __name__ == "__main__":
    ...
    plt.plot(tr_loss_log, label='train loss')
    plt.plot(val_loss_log, label='valid loss')
    plt.legend()
    plt.show()

    plt.plot(tr_acc_log, label='train acc')
    plt.plot(val_acc_log, label='valid acc')
    plt.legend()
    plt.show()

'''
Train Accuracy: 0.4001
